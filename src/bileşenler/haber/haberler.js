...
function haberYapici(haber) {
  ...
  newH2.classList.add("baslik");
  newArticle.appendChild(newH2);

  const newTarih = document.createElement("p");
  newTarih.classList.add("tarih");
  newTarih.textContent = haber.tarih;
  newArticle.appendChild(newTarih);

  const para1 = document.createElement("p");
  para1.textContent = haber.ilkParagraf;
  newArticle.appendChild(para1);

  const para2 = document.createElement("p");
  para2.textContent = haber.ikinciParagraf;
  newArticle.appendChild(para2);

  const para3 = document.createElement("p");
  para3.textContent = haber.ucuncuParagraf;
